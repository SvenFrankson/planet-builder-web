class PlanetChunckNice extends PlanetChunck {
    ...
    public syncWithAdjacents(): boolean {
        ...
        this.findAdjacents();
        let right = this._adjacents[2][1][1];
        ...
        for (let n = 0; n < PlanetTools.CHUNCKSIZE; n++) {
            this.data[n][PlanetTools.CHUNCKSIZE][PlanetTools.CHUNCKSIZE] = this._adjacents[1][2][2].GetDataNice(n, 0, 0);
            this.data[PlanetTools.CHUNCKSIZE][n][PlanetTools.CHUNCKSIZE] = this._adjacents[2][1][2].GetDataNice(0, n, 0);
            this.data[PlanetTools.CHUNCKSIZE][PlanetTools.CHUNCKSIZE][n] = this._adjacents[2][2][1].GetDataNice(0, 0, n);
        }
        this.data[PlanetTools.CHUNCKSIZE][PlanetTools.CHUNCKSIZE][PlanetTools.CHUNCKSIZE] = this._adjacents[2][2][2].GetDataNice(0, 0, 0);
