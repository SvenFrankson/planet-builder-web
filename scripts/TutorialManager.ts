...
class TutorialManager {
        ...
        if (this.player.inputHeadUp != 0 || this.player.inputHeadRight != 0) {
            ...
            if (this.waitForLookAroundTimer > 2) {
                ...
                this.main.subtitleManager.display(Subtitle.Create(["Well done ! You can now look around."], 3)).then(() => {
                    this.main.subtitleManager.display(Subtitle.Create(["Lesson 1.a / 87 - Movement. Press ", "<span class='keyboard'>W</span>", ", ", "<span class='keyboard'>A</span>", ", ", "<span class='keyboard'>S</span>", " and ", "<span class='keyboard'>D</span>", " to move."], 10, 3));
        ...
        if (this.player.inputForward != 0 || this.player.inputRight != 0) {
            ...
            if (this.waitForMoveTimer > 2) {
                ...
                this.main.subtitleManager.display(Subtitle.Create(["Ok, you know how to move."], 3)).then(() => {
                    this.main.subtitleManager.display(Subtitle.Create(["Lesson 1.b / 87 - Move To Location. Hold clic ", "<img src='datas/icons/mouse-left.svg'/>", " in place to move to target location."], 10, 3));
        ...
        if (this.player.isPosAnimating) {
            ...
            if (this.waitForMoveToLocationTimer > 0.5) {
                ...
                this.main.subtitleManager.display(Subtitle.Create(["Nice, that's how you move to target location."], 3)).then(() => {
                    this.main.subtitleManager.display(Subtitle.Create(["Lesson 1.c / 87 - Jump. Press ", "<span class='keyboard'>SPACE</span>", " to jump."], 10, 3));
    ...
    private onJump = () => {
        ...
        this.main.subtitleManager.display(Subtitle.Create(["That's a new height record !"], 3)).then(() => {
            this.main.subtitleManager.display(Subtitle.Create(["Lesson 1.d / 87 - Open Menu. Press ", "<span class='keyboard'>²</span>", " to open Planet Selection Menu."], 10, 3));
